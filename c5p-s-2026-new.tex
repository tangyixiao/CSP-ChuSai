...
\q{34.} ②处应填（\qquad）\\
\optw{A. \texttt{pos[c][used[c]]}}{B. \texttt{pos[c][used[c]+1]}}
\optw{C. \texttt{pos[c][cnt[c]-used[c]]}}{D. \texttt{pre[c][used[c]+1]}}
\q{35.} ③处应填（\qquad）\\
\optw{A. \texttt{x-len-1}}{B. \texttt{x-len}}
\optw{C. \texttt{len+1-x}}{D. \texttt{x-1}}
\q{36.} ④处应填（\qquad）\\
\optw{A. \texttt{max(0,pre[t][x]-used[t])}}{B. \texttt{max(0,used[t]-pre[t][x])}}
\optw{C. \texttt{min(used[t],pre[t][x])}}{D. \texttt{used[t]-pre[t][x-1]}}
\q{37.} ⑤处应填（\qquad）\\
\optw{A. \texttt{w}}{B. \texttt{val+x}}
